...
You explain your need to get further underground. \"Well, you could at least take the escalator down to the printing department, not that you\'d get much further than that without the elevators working. That is, you could if the escalator weren\'t also [offline]{title="Escalator temporarily stairs. Sorry for the convenience."}.\"
